...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float textAscent = metrics.ascent;
        float textDescent = metrics.descent;
        float textBottom = metrics.bottom;
        float height = textDescent - textAscent;

        float middle = (top + bottom) / 2 + height/4 ;
